    ...
    if (enteredMail.trim().length === 0) {
      ...
      const resData = () => {
        ...
        sendRequest(
          {
            request: "POST",
            url: `https://mailbox-client-dd027-default-rtdb.firebaseio.com/sent${userMail}.json`,
            data: dataObj,
      ...
      sendRequest(
        {
          request: "POST",
          url: `https://mailbox-client-dd027-default-rtdb.firebaseio.com/receive${mail2}.json`,
          data: dataObj,
          header: { "Content-type": "application/json" },
        },
        resData
